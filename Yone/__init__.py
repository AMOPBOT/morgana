...
if ENV:
    TOKEN = os.environ.get("TOKEN", "5808748296:AAGqmRPuBxl47viDpKFVirgX-eL__ojIlZg")
    ...
    DB_URI = os.environ.get("DATABASE_URL","postgres://mqcodhup:WHSi5X3wFJwDQeTl8PXS4hb-PInzGxQo@bubble.db.elephantsql.com/mqcodhup")
