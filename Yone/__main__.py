...
from Yone.Database.users_sql import start_user
...
PM_START_TEXT = """ Hello *{}*, My name is *{}*, a Telegram group management bot. I can help you manage your group and keep it running smoothly. Type /help to learn more about what I can do. And if you want to stay up to date with the latest news and updates, be sure to join my [news channel](http://t.me/Yone_Updates). Thanks for choosing me!
"""
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            stringz = "My dear Owner, I'm Working Again.\nThanks to make me live."
            dispatcher.bot.sendMessage(OWNER_ID, stringz)
        except Unauthorized:
            LOGGER.warning(
